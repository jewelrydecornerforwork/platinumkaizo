    ...
    <div className="relative min-h-screen overflow-hidden px-6 pb-8 pt-12 md:px-12 md:pt-14">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          <section className="grid grid-cols-12 gap-4 xl:auto-rows-[minmax(112px,auto)]">
            <NavCard href="/calculator" className="col-span-12 lg:col-span-6 lg:row-span-2">
              <TacticalFrame
            ...
            <NavCard href="/trainers" className="col-span-12 md:col-span-6 lg:col-span-3">
              <TacticalFrame
            ...
            <TacticalFrame
              title="State Cell"
              subtitle="SYS_NODE"
              className="col-span-12 md:col-span-4 lg:col-span-2 shadow-[0_0_26px_rgba(16,185,129,0.06),inset_0_1px_3px_rgba(16,185,129,0.3)]"
            >
            ...
            <TacticalFrame
              ...
              className="col-span-12 lg:col-span-7 shadow-[0_0_28px_rgba(16,185,129,0.06),inset_0_1px_3px_rgba(16,185,129,0.3)]"
            >
              <StatusMedals />
            </TacticalFrame>
            ...
            <TacticalFrame
              ...
              subtitle="TARGET_GRID"
              className="col-span-12 lg:col-span-6 shadow-[0_0_28px_rgba(16,185,129,0.06),inset_0_1px_3px_rgba(16,185,129,0.3)]"
            >
            ...
            <TacticalFrame
              ...
              className="col-span-12 lg:col-span-6 shadow-[0_0_22px_rgba(15,23,42,0.7),inset_0_1px_3px_rgba(16,185,129,0.3)]"
            >
